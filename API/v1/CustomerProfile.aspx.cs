...
namespace ServiceWeb.API.v1
{
    public partial class CustomerProfile : System.Web.UI.Page
    {
        ...
        private void initData()
        {
            ...
            CustomerProfileEn customerProfileEn = new CustomerProfileEn();
            customerProfileEn = customerProfileLib.finalDateModel();
            var json = new JavaScriptSerializer().Serialize(customerProfileEn);
            Response.Write(json);
            //Response.Write(responseJson);
            #endregion
