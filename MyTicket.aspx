<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeBehind="MyTicket.aspx.cs" Inherits="ServiceWeb.MyTicket" %>
    ...
    <div>
        <script>
            ...
            function webOnLoad() {
                ...
                //set new active
                document.getElementById("nav-menu-myticket").className = "nav-link active";
            };
        ...
        <script>
            ...
            function bindDataMyTicket() {
                ...
                $.ajax({
                    type: "POST",
                    url: servictWebDomainName + "API/v1/GetTicketMyTicketAPI.aspx",
                    data: postData,
                    success: function (datas) {
                        ...
                        myTaskDataTable = bindListMyTicket($("#tableItemsMyTicket"), objDatasMyTicket.my_ticket);
                    ...
                    'columnDefs': [
                       ...
                       },
                       {
                           ...
                           'createdCell': function (td, cellData, rowData, row, col) {
                               ...
                               //    $(td).addClass("text-warning col-ticket-type text-nowrap");
                               //}
                               //else {
                               //    $(td).addClass("text-danger col-ticket-type text-nowrap");
                               //}
