...
function startCountDown(countDownValue, containerId) {
    $(function () {
        $(".detail_your_time_countdown").remove();
            ...
            for (var i = 0; i < options.startTime.length; i++) {
                if (parseInt(options.startTime[i]) >= 0) {
                    ...
                    elem = $('<div id="cnt_' + counter + '" class="cntDigit" />').css({
                        ...
                        float: 'left',
                        background: 'url(\'/timeattendance/' + options.image + '\')',
        ...
        var countDown = $("<div/>", {
            class: "detail_your_time_countdown",
            id: uuid
        });

        $("#" + containerId).append(countDown);

        $(countDown).countdown({
            startTime: countDownValue,
            image: "activitylib/countdown/img/digits.png"
        });
