<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmartSearchOtherDelegate.ascx.cs" Inherits="ServiceWeb.UserControl.SmartSearchOtherDelegate" %>
...
<div class="smart-other-delegate-template-<%= ID %>" style="display: none;">
    <div class="col-sm-4 smart-other-delegate-temp" style="padding: 0 5px; padding-top: 5px;">
        <div class="input-group" style="margin-bottom: 0px;margin-top:0px;">
            ...
            <span class="input-group-append hand" onclick="$(this).closest('.smart-other-delegate-temp').remove();resultSelectedSmartOtherDelegate<%= ID %>();event.stopPropagation();" style="cursor: pointer">
...
<div class="input-group">
    <div class="form-control input-group-other-delegate-<%= ID %> blue-require-style" style="padding: 5px 0px; padding-top: 0px; height: auto;" onclick="$('.input-group-other-delegate-<%= ID %> .form-control-smart').click();event.stopPropagation();">
        <div class="smart-other-delegate-result" style="margin-bottom: 0px;margin-top:0px;">
    ...
    <span class="input-group-append hand" style="cursor: pointer;" onclick="$('.input-group-other-delegate-<%= ID %> .form-control-smart-search').click();event.stopPropagation();">
