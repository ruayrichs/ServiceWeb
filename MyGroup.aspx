<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeBehind="MyGroup.aspx.cs" Inherits="ServiceWeb.MyGroup" %>
    ...
    <div>
        <script>
            ...
            function webOnLoad() {
                ...
                //set new active
                document.getElementById("nav-menu-mygroup").className = "nav-link active";
            };
        ...
        <script>
            ...
            function bindDataMyTicket() {
                ...
                $.ajax({
                    type: "POST",
                    url: servictWebDomainName + "API/v1/GetTicketMyGroupAPI.aspx",
                    data: postData,
