...
namespace ServiceWeb.crm.API
{
    public partial class CompanyStructureAPI : System.Web.UI.Page
    {
        DBService db = new DBService();
        CRMAccountabilityService accountService = new CRMAccountabilityService();
        ...
        private List<CRMCompanyStructureModel> _ListProductCategory = null;
        private List<CRMCompanyStructureModel> ListProductCategory
        {
            get
            {
                return _ListProductCategory == null ? CRMCompanyStructureModel.GetProductCategory(ERPWAuthentication.SID, WorkGroupCode) : _ListProductCategory;
            }
        }
        ...
        private string getStrSqlMoveNode(CRMCompanyStructureModel node, string NewParentNodeID, int NextLevel)
        {
            ...
            string sql = "update LINK_PROJECT_COMPANY_STRUCTURE_ITEM set NodeHierarchyCode = '" + NewNodeHierarchyCode + "'";
        ...
        private void RenameNode()
        {
            ...
            string sql = "update LINK_PROJECT_COMPANY_STRUCTURE_ITEM set StructureName = '" + newName + "'";
        ...
        private string NewFolder()
        {
            ...
            String sqlNodeLevel = "SELECT Top 1 [SID],[CompanyCode],[StructureCode],[Name] ";
            sqlNodeLevel += ",[Description],[NodeLevel],[created_by],[created_on] ";
            sqlNodeLevel += "FROM [LINK_PROJECT_COMPANY_STRUCTURE] where WorkGroupCode = '" + WorkGroupCode + "' ORDER BY [NodeLevel] desc";
            ...
            if (dataTableLinkProjectCompanyStructure.Rows.Count > 0)
            {
                ...
                {
                    string sql = @"insert into LINK_PROJECT_COMPANY_STRUCTURE_ITEM 
                    ...
                    sql += ",'" + WorkGroupCode + "'";
                    sql += ",'" + GetGenerateNextID("LINK_PROJECT_COMPANY_STRUCTURE_ITEM", "StructureCode", "CT", 10) + "'";
                    sql += ",'" + name + "'";
        ...
        private string GetSqlDeleteNode(CRMCompanyStructureModel node)
        {
            string sql = "delete from LINK_PROJECT_COMPANY_STRUCTURE_ITEM ";
        ...
        private CRMCompanyStructureModel GetNewNodeStructure(string ParentNodeCode)
        {
            ...
            return new CRMCompanyStructureModel
            {
