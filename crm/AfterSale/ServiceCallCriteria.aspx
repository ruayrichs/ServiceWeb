<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeBehind="ServiceCallCriteria.aspx.cs" Inherits="ServiceWeb.crm.AfterSale.ServiceCallCriteria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-SearchServiceCall").className = "nav-link active";
        };
    ...
    <script>
        function beforeSearch() {
            if (document.getElementById("_txt_docnumber").value == "'") {
                document.getElementById("_txt_docnumber").value = "''";
            }
        }
    </script>
    <style>
    ...
    <div class="row d-none">
        <div class="col">
            <div class="card shadow">
                ...
                <button type="button" class="btn btn-info AUTH_MODIFY" onclick="inactiveRequireField();$('#<%= btnOpenModalSearch.ClientID%>').click();"><i class="fa fa-search"></i>&nbsp;&nbsp;Search</button>
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="form-row">
                                                            <div class="form-group col-lg-6 col-sm-12">
                                                                ...
                                                                <asp:TextBox ID="txtContactEmail_search" runat="server"
                                                            ...
                                                            <div class="form-group col-lg-12 col-sm-12">
                                                                ...
                                                                <asp:TextBox ID="txtContactremark_search" Enabled="false" runat="server" TextMode="MultiLine"
                                                                    CssClass="form-control form-control-sm" Rows="1"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="card border-primary" style="margin-bottom: 10px;">
                                            <div class="card-body card-body-sm div-search-box">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-sm-6">
                                                        <label>Earliest Open Date</label>
                                                        <div class="input-group">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label>Earliest Open Time</label>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="ctrlTimeFrom" runat="server" CssClass="form-control form-control-sm time-picker ticket-allow-editor"></asp:TextBox>
                                                            <div class="input-group-append">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label>Latest Open Time</label>
                                                        <div class="input-group">
                                                            <asp:TextBox ID="ctrlTimeTo" runat="server" CssClass="form-control form-control-sm time-picker ticket-allow-editor"></asp:TextBox>
                                                            <div class="input-group-append">
                                                                <span class="input-group-text"><i class="fa fa-clock-o"></i></span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-row d-none">
                                                    ...
                                                    <div class="form-group col-lg-12 col-sm-12">
                                                        ...
                                                        <asp:TextBox ID="txtSearchDiscription" runat="server"
                                                            CssClass="form-control form-control-sm"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <asp:UpdatePanel ID="udpnOwnerService" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:DropDownList ID="ddlOwnerGroupService" CssClass="form-control form-control-sm" runat="server"
                                                            DataValueField="OwnerGroupCode" DataTextField="OwnerGroupName"
                                                            AutoPostBack="true" OnSelectedIndexChanged="ddlOwnerGroupService_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            $("#_txt_docnumber").on("keyup", function (event) {
                var currentEl = $(this);
        ...
        function resetTextForSearch() {
            setTimeout(function () {
                ...
                $("#<%= _ddl_ticket_Doc_Status.ClientID%>").val('');
                $("#<%= ddlOwnerGroupService.ClientID%>").val('');
    ...
    <script type="text/javascript">
        ...
        function afterSearch() {
            ...
            for (var i = 0 ; i < reportsList.length ; i++) {
                ...
                var CustomerCall = '';
                if (report.CustomerCritical == 'CRITICAL') {
                    CustomerCall = '<span><img src="/images/icon/flag-red-512.png" width="20" height="20">&nbsp;</span>' + report.CustomerName;
                } else {
                    if (report.CustomerName) {
                        CustomerCall = report.CustomerName;
                    }
                }
                ...
                data.push([
                    ...
                    report.HeaderText,
                    CustomerCall,
                    (report.ContractPersonName ? report.ContractPersonName : ""),
                    (report.EquipmentName ? report.EquipmentName : ""),
                    (report.ImpactName ? report.ImpactName : ""),
                    (report.UrgencyName ? report.UrgencyName : ""),
                    (report.PriorityName ? report.PriorityName : ""),
                    (report.OwnerGroupName ? report.OwnerGroupName : ""),
                    (report.FullName_EN ? report.FullName_EN : "")
                ]);
            }
            //console.log(data);
            var startDATEend;
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            var dataDB = startDATEend[0].substring(0, 8);
                    ...
                    },
                    {
                        ...
                        'createdCell': function (td, cellData, rowData, row, col) {
                            var timeDB = cellData;
                            var dataDisplay = timeDB.substring(0, 2) + ":" + timeDB.substring(2, 4) + ":" + timeDB.substring(4, 6);
                            $(td).addClass('text-nowrap');
                            $(td).html(dataDisplay);
                        }
                    },
                    {
                        ...
                        'createdCell': function (td, cellData, rowData, row, col) {
                            ...
                            var CallerIDDisplay = datas[0];
                            var CallerID = datas[1];
                            var CallStatus = datas[2];
                            ...
                            if (enddate != "null") {
                                if (date < today) {
                                    $(td).html(
                                        '<div Title="End Date: ' + convertToDateDisplay(date) + '">' + CallerIDDisplay + '&nbsp;&nbsp;<p class="fa fa-hourglass-end text-danger"></p></div>'
                                    );
                                } else if (date > today) {
                                    $(td).html(
                                        '<div Title="End Date: ' + convertToDateDisplay(date) + '">' + CallerIDDisplay + '&nbsp;&nbsp;<p class="fa fa-hourglass-start text-primary"></p></div>'
                                    );
                                } else {
                                    $(td).html(
                                        '<div>' + CallerIDDisplay + '</div>'
                                    );
                                }
                            } else {
                                $(td).html(
                                    '<div Title="End Date: ' + convertToDateDisplay(date) + '">' + CallerIDDisplay + '&nbsp;&nbsp;<p class="fa fa-hourglass-o text-dark"></p></div>'
                                );
                            }

                            //$(td).html(CallerIDDisplay);
                            $(td).addClass('text-nowrap');
                            $(td).parent().addClass(GetRowColorAssign(CallStatus));
            ...
            //});
            $("body").scrollTop($("#divSearch").position().top);

            function GetRowColorAssign(status) {
                if ('<%= ERPW.Lib.Service.ServiceTicketLibrary.SERVICE_CALL_STATUS_CANCEL %>' == status) {
                    return 'text-danger';
                } else if ('<%= ERPW.Lib.Service.ServiceTicketLibrary.SERVICE_CALL_STATUS_CLOSE %>' == status) {
                    return 'text-success';
                } else {
                    return '';
                }
