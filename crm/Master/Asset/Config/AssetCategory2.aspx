<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/RedesignV2/DefaultMasterPageV2.master" AutoEventWireup="true" CodeBehind="AssetCategory2.aspx.cs" Inherits="ServiceWeb.crm.Master.Asset.Config.AssetCategory2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div>
            ...
            <div class="row">
                <div class="col-lg-2">
                    <asp:Label Text="Asset Category1" runat="server" />
                </div>
                <div class="col-lg-4">
                    <asp:DropDownList ID="ddlAssetCategory1" CssClass="form-control" ClientIDMode="Static" runat="server" DataTextField="Description" DataValueField="AssetCategory">
                    </asp:DropDownList>
                </div>
                        ...
                        <ContentTemplate>
                            <asp:GridView border="0" ID="gvData" runat="server" CssClass="table table-striped table-hover table-bordered" PagerStyle-CssClass="gvpaging"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Edit" ItemStyle-Width="150px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" CssClass="fa fa-pencil-square-o fa-2x AUTH_UPDATE" Style="color: #222222;"
                                                runat="server" OnClick="GridgvData_EditItem" CommandName='<%# Eval("AssetCategory")+","+ Eval("AssetGroup")+","+Eval("AssetType")+","+Eval("AssetCategory1") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Delete" ItemStyle-Width="150px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton2" CssClass="fa fa-trash fa-2x AUTH_DELETE" Style="color: Red;"
                                                runat="server" CommandName='<%# Eval("AssetCategory")+","+ Eval("AssetGroup")+","+Eval("AssetType")+","+Eval("AssetCategory1") %>' OnClick="GridgvData_DeleteItem"
                                    ...
                                    <asp:BoundField HeaderText="Asset Category1" DataField="AssetCategoryName" />
                                </Columns>
                    ...
                    <ContentTemplate>
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title">Asset Category 2  </h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>
                                            <asp:Label runat="server" ID="label2" Text=" Asset Type "></asp:Label>
                                        </label>
                                        <span class="requireItem">*</span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label>
                                            <asp:Label runat="server" ID="label3" Text="Asset Category1"></asp:Label>
                                        </label>
                                        <span class="requireItem">*</span>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <asp:DropDownList ID="ddlAssetCategory1Modal" CssClass="form-control" ClientIDMode="Static" runat="server" DataTextField="Description" DataValueField="AssetCategory">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                    ปิด</button>
                                <asp:Button Text="สร้าง" runat="server" ID="btnCreateAssetCategory2" CssClass="btn btn-success"
                                    OnClick="btnCreateAssetCategory2_Click" OnClientClick="return AGConfirm('ยืนยันการบันทึก');" />
                                <asp:Button Text="แก้ไข" runat="server" ID="btnEditAssetCategory2" CssClass="btn btn-success" OnClick="btnEditAssetCategory2_Click"
