<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmartSearchMainDelegate.ascx.cs" Inherits="ServiceWeb.widget.usercontrol.SmartSearchMainDelegate" %>
...
<div class="smart-main-delegate-template-<%= ID %>" style="display: none;">
    <div class="col-sm-4 smart-main-delegate-temp" onclick="$('.input-group-main-delegate-<%= ID %> .form-control-smart-search').click();event.stopPropagation();" style="padding: 0 5px;">
        <div class="input-group" style="margin-bottom: 0px;margin-top:0px;">
            ...
            <span class="input-group-addon input-group-append" onclick="$(this).closest('.smart-main-delegate-temp').remove();$('.input-group-main-delegate-code-<%= ID %>,.input-group-main-delegate-value-<%= ID %>').val('');event.stopPropagation();" style="cursor: pointer">
                <i class="input-group-text fa fa-remove" style="padding-top: 9px;"></i>
            </span>
        </div>
    </div>
</div>
<div class="input-group">
                        ...
                        <ItemTemplate>
                            <tr class="smart-search-popup-result-row" data-code="<%# Eval("EmployeeCode") %>" data-value="<%# Eval("Firstname_TH") + " " + Eval("Lastname_TH") + " ("+ Eval("Firstname") + " " + Eval("Lastname") +")" %>">
                                <td style="width: 100px;" class="text-center">
                                    <div class="img-circle-box" style="background-image:url('<%# GetImage(Eval("EmployeeCode"),Eval("UPDATED_ON")) %>'), url('/images/user.png');">
                                    </div>
                                </td>
    ...
    <span class="input-group-addon input-group-append" onclick="$('.input-group-main-delegate-<%= ID %> .form-control-smart-search').click();event.stopPropagation();" style="cursor: pointer;">
        <i class="input-group-text fa fa-search" style="padding-top: 15px;"></i>
    </span>
</div>
