<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeBehind="ReportConfigurationItem.aspx.cs" Inherits="ServiceWeb.Report.ReportConfigurationItem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-Report-Configuration-Item").className = "nav-link active";
        };
    ...
    <div class="card shadow">
        <div class="card-header">
            <h5 class="mb-0">Configuration Item</h5>
        </div>
        <div class="card-body">
