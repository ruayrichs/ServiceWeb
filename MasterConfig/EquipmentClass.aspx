<%@ Page Title="" Language="C#" MasterPageFile="~/MasterConfig/MasterPage/MasterPageConfig.master" AutoEventWireup="true" CodeBehind="EquipmentClass.aspx.cs" Inherits="ServiceWeb.MasterConfig.EquipmentClass" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderConfig" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-config-item-class").className = "nav-link active";
        };
    ...
    <nav class="navbar nav-header-action sticky-top bg-white" style="margin-left: 1px; margin-right: 1px;">
        <div class="pull-left">
            <asp:UpdatePanel ID="udpnAction" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <button type="button" class="btn btn-primary mb-1 AUTH_MODIFY" onclick="openCreate();"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New Configuration Item Class</button>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </nav>
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header">
                    <h5 class="mb-0">Configuration Item Class</h5>
                </div>
                <div class="card-body">
                                ...
                                <table id="tableItems" class="table table-bordered table-striped table-hover table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-nowrap">Material Group Desc</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="text-nowrap text-center align-middle">
                                                        <i class="fa fa-edit fa-lg text-dark mx-1 AUTH_MODIFY" title="Edit" onclick="openEdit('<%# Eval("ClassCode") %>');"></i>                                                        
                                                        <i class="fa fa-times-circle-o fa-lg text-danger mr-1 AUTH_MODIFY" title="Delete" onclick="confirmDelete(this);"></i>
                                                        <asp:Button ID="btnDelete" runat="server" CssClass="d-none AUTH_MODIFY" OnClick="btnDelete_Click" CommandArgument='<%# Eval("ClassCode") %>' />
                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-header">Configuration Item Class</h5>
                    ...
                    <asp:UpdatePanel ID="udpn" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:Panel runat="server" DefaultButton="btnSave">
                                ...
                                <div class="form-group">
                                    <label>Family</label>
                                    <asp:DropDownList runat="server" CssClass="form-control form-control-sm required" ID="ddlCIFamily" >
                                    </asp:DropDownList>
                                </div>
    ...
    <script>
        ...
        function openModal(mode) {
            ...
            $("#modal-header").html(mode + " Configuration Item Class");
