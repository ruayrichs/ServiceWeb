<%@ Page Title="" Language="C#" MasterPageFile="~/MasterConfig/MasterPage/MasterPageConfig.master" AutoEventWireup="true" CodeBehind="TicketStatus.aspx.cs" Inherits="ServiceWeb.MasterConfig.TicketStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderConfig" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-ticket-status").className = "nav-link active";
        };
    ...
    <nav class="navbar nav-header-action sticky-top bg-white" style="margin-left: 1px; margin-right: 1px;">
        <div class="pull-left">
            <asp:UpdatePanel ID="udpnAction" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <button type="button" class="btn btn-primary mb-1 AUTH_MODIFY" onclick="openCreate();"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New Ticket Status</button>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </nav>
                                ...
                                <table id="tableItems" class="table table-bordered table-striped table-hover table-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th class="text-nowrap">Stop Timer</th>
                                            <th class="text-nowrap">EventType</th>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <tr>
                                                    <td class="text-nowrap text-center align-middle">
                                                        <i class="fa fa-edit fa-lg text-dark mx-1 AUTH_MODIFY" title="Edit" onclick="openEdit('<%# Eval("TicketStatusCode") %>');"></i>                                                        
                                                        <i class="fa fa-times-circle-o fa-lg text-danger mr-1 AUTH_MODIFY" title="Delete" onclick="confirmDelete(this);"></i>
                                                        <asp:Button ID="btnDelete" runat="server" CssClass="d-none AUTH_MODIFY"  OnClick="btnDelete_Click" CommandArgument='<%# Eval("TicketStatusCode") %>' />
                                                    </td>
                                                    <td class="text-nowrap">
                                                        <%# Eval("TicketStatusCode") %>
                                                    </td>
                                                    <td>
                                                        <%# Eval("TicketStatusDesc") %>
                                                    </td>
                                                     <td class="text-center">
                                                        <input type="checkbox" <%# Convert.ToString(Eval("StopTimer")) == "True" ? "checked" : "" %> />
                                                    </td>
                                                     <td>
                                                        <%# convertTypeToDesc(Eval("EventType").ToString()) %>
                                                    </td>
                                                    <td class="text-nowrap">
                                                        <%# Eval("CREATED_BY") %>
                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-header">Ticket Status</h5>
                    ...
                    <asp:UpdatePanel ID="udpn" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlEventType" CssClass="form-control form-control-sm" runat="server">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                               <label>Stop Timer</label>&nbsp;&nbsp;
                               <asp:CheckBox ID="chkStopTimer" Text="" runat="server" />
                            </div>
    ...
    <script>
        ...
        function openModal(mode) {
            ...
            $("#modal-header").html(mode + " Ticket Status");
