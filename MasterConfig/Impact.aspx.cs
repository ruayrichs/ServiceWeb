...
{
    public partial class Impact : AbstractsSANWebpage
    {
        ...
        {
            DataTable dt = lib.GetMasterConfigImpact(ERPWAuthentication.SID);
        ...
        protected void btnSetEdit_Click(object sender, EventArgs e)
        {
            ...
            {              
                ...
                DataTable dt = lib.GetMasterConfigImpact(ERPWAuthentication.SID, code);

                if (dt.Rows.Count > 0)
                {
                    hdfMode.Value = ApplicationSession.CHANGE_MODE_STRING;

                    tbCode.Text = dt.Rows[0]["ImpactCode"].ToString();
                    tbName.Text = dt.Rows[0]["ImpactName"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lib.CreateMasterConfigImpact(ERPWAuthentication.SID, code, name, ERPWAuthentication.UserName);                    
                }
                else if (hdfMode.Value.Equals(ApplicationSession.CHANGE_MODE_STRING))
                {
                    lib.UpdateMasterConfigImpact(ERPWAuthentication.SID, code, name, ERPWAuthentication.UserName);
                }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lib.DeleteMasterConfigImpact(ERPWAuthentication.SID, code);
