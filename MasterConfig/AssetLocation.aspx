<%@ Page Title="" Language="C#" MasterPageFile="~/MasterConfig/MasterPage/MasterPageConfig.master" AutoEventWireup="true" CodeBehind="AssetLocation.aspx.cs" Inherits="ServiceWeb.MasterConfig.AssetLocation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderConfig" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-asset-location").className = "nav-link active";
        };
    ...
    <nav class="navbar nav-header-action sticky-top bg-white" style="margin-left: 1px; margin-right: 1px;">
        <div class="pull-left">
            <asp:UpdatePanel ID="udpnAction" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <button type="button" class="btn btn-primary mb-1 AUTH_MODIFY" onclick="openCreate();"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New Asset Location</button>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </nav>
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header">
                    <h5 class="mb-0">Asset Location</h5>
                </div>
                <div class="card-body">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="text-nowrap text-center align-middle">
                                                        <i class="fa fa-edit fa-lg text-dark mx-1 AUTH_MODIFY" title="Edit" onclick="openEdit('<%# Eval("AssetLocation") %>');"></i>
                                                        <i class="fa fa-times-circle-o fa-lg text-danger mr-1 AUTH_MODIFY" title="Delete" onclick="confirmDelete(this);"></i>
                                                        <asp:Button ID="btnDelete" runat="server" CssClass="d-none AUTH_MODIFY" OnClick="btnDelete_Click" CommandArgument='<%# Eval("AssetLocation") %>' />
                                                    </td>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <%# string.IsNullOrEmpty(Eval("CostCenterCode").ToString()) ? "" : Eval("CostCenterCode") + " : " + Eval("COSTCENTERNAME") %>
                                                    </td>
                                                    <td class="text-nowrap">
                                                        <%# Eval("CREATED_BY") %>
                                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-header">Asset Location</h5>
                    ...
                    <asp:UpdatePanel ID="udpn" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlCostCenter" runat="server" CssClass="form-control form-control-sm">
                                </asp:DropDownList>
                            </div>
    ...
    <script>
        ...
        function openModal(mode) {
            ...
            $("#modal-header").html(mode + " Asset Location");
