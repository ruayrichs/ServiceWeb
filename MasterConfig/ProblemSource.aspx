<%@ Page Title="" Language="C#" MasterPageFile="~/MasterConfig/MasterPage/MasterPageConfig.master" AutoEventWireup="true" CodeBehind="ProblemSource.aspx.cs" Inherits="ServiceWeb.MasterConfig.ProblemSource" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderConfig" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-problem-source").className = "nav-link active";
        };
     ...
     <nav class="navbar nav-header-action sticky-top bg-white" style="margin-left: 1px; margin-right: 1px;">
        <div class="pull-left">
            <asp:UpdatePanel ID="udpnAction" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <button type="button" class="btn btn-primary mb-1 AUTH_MODIFY" onclick="openCreate();"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New Problem Source</button>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </nav>
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header">
                    <h5 class="mb-0">Problem Source</h5>
                </div>
                <div class="card-body">
                                                ...
                                                <tr>
                                                    <td class="text-nowrap text-center align-middle">
                                                        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <i class="fa fa-edit fa-lg text-dark mx-1 AUTH_MODIFY" title="Edit" onclick="openEdit('<%# Eval("BUSINESSOBJECT") %>','<%# Eval("GROUPCODE") %>','<%# Eval("TYPECODE") %>','<%# Eval("SOURCECODE") %>');"></i>                                                        
                                                                <i class="fa fa-times-circle-o fa-lg text-danger mr-1 AUTH_MODIFY" title="Delete" onclick="confirmDelete(this);"></i>
                                                                <asp:Button ID="btnDelete" runat="server" CssClass="d-none AUTH_MODIFY" OnClick="btnDelete_Click" CommandArgument='<%# Eval("SOURCECODE") %>' />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-header">Problem Source</h5>
                    ...
                    <asp:UpdatePanel ID="udpn" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="form-group" runat="server">
                                ...
                                <asp:Button ID="btnSetGroupType" ClientIDMode="Static" OnClick="btnSetTypeData_Click" OnClientClick="inactiveRequireField();AGLoading(true);" CssClass="d-none" runat="server" />
                            </div>
                             <div class="form-group" runat="server">
                                <label>Problem Type</label>
                                <asp:DropDownList ID="ddlProblemType" CssClass="form-control form-control-sm required" runat="server">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                <label>Code</label>
    ...
    <script>
        ...
        function openEdit(business,group,typecode,code) {
            inactiveRequireField();
        ...
        function openModal(mode) {
            ...
            $("#modal-header").html(mode + " Problem Source");
