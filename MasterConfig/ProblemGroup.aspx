<%@ Page Title="" Language="C#" MasterPageFile="~/MasterConfig/MasterPage/MasterPageConfig.master" AutoEventWireup="true" CodeBehind="ProblemGroup.aspx.cs" Inherits="ServiceWeb.MasterConfig.ProblemGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderConfig" runat="server">
    <script>
        function webOnLoad() {
            ...
            //set new active
            document.getElementById("nav-menu-problem-group").className = "nav-link active";
        };
     ...
     <nav class="navbar nav-header-action sticky-top bg-white" style="margin-left: 1px; margin-right: 1px;">
        <div class="pull-left">
            <asp:UpdatePanel ID="udpnAction" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <button type="button" class="btn btn-primary mb-1 AUTH_MODIFY" onclick="openCreate();"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;New Problem Group</button>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </nav>
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header">
                    <h5 class="mb-0">Problem Group</h5>
                </div>
                <div class="card-body">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td class="text-nowrap text-center align-middle">
                                                        <i class="fa fa-edit fa-lg text-dark mx-1 AUTH_MODIFY" title="Edit" onclick="openEdit('<%# Eval("GroupCode") %>','<%# Eval("BUSINESSOBJECT") %>');"></i>                                                        
                                                        <i class="fa fa-times-circle-o fa-lg text-danger mr-1 AUTH_MODIFY" title="Delete" onclick="confirmDelete(this);"></i>
                                                        <asp:Button ID="btnDelete" runat="server" CssClass="d-none AUTH_MODIFY"  OnClick="btnDelete_Click" CommandArgument='<%# Eval("GroupCode") %>' />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-header">Problem Group</h5>
                        ...
                        <ContentTemplate>
                            <asp:Panel runat="server" DefaultButton="btnSave">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlBusinessObject" CssClass="form-control form-control-sm required" runat="server">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Owner Group Service</label>
                                    <asp:DropDownList ID="ddlOwnerGroup" CssClass="form-control form-control-sm" runat="server">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group">
                                    <label>Code</label>
                                ...
                                <asp:HiddenField ID="hdfBusinessOBjCode" runat="server" />
    ...
    <script>
        ...
        function openEdit(code, business) {
            inactiveRequireField();
            $("#<%= hdfEditCode.ClientID %>").val(code);
            $("#<%= hdfBusinessOBjCode.ClientID %>").val(business);
        ...
        function openModal(mode) {
            ...
            $("#modal-header").html(mode + " Problem Group");
