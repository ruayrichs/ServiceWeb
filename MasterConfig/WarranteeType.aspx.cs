...
{
    public partial class WarranteeType : AbstractsSANWebpage
    {
        ...
        {
            DataTable dt = lib.GetMasterConfigWarranty(ERPWAuthentication.SID);
        ...
        protected void btnSetEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = lib.GetMasterConfigWarranty(ERPWAuthentication.SID, code);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lib.CreateMasterConfigWarranty(ERPWAuthentication.SID, code, name, ERPWAuthentication.UserName);
                }
                else if (hdfMode.Value.Equals(ApplicationSession.CHANGE_MODE_STRING))
                {
                    lib.UpdateMasterConfigWarranty(ERPWAuthentication.SID, code, name, ERPWAuthentication.UserName);
                }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                lib.DeleteMasterConfigWarranty(ERPWAuthentication.SID, code);
